...
function App() {
  ...
  const [answeredAgents, setAnsweredAgents] = useState([])
  ...
  const agentNames = quizOrder
    .map(q => q.agent)
    .filter(name => !answeredAgents.includes(name) || name === question.agent)
  ...
  function checkAnswer() {
    if (input.trim().toLowerCase() === question.agent.toLowerCase()) {
      ...
      setShowResult(true)
      setAnsweredAgents([...answeredAgents, question.agent])
